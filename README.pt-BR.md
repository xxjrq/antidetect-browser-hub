# Recursos de Anti-Detect Browsers
...
- [Navegadores](docs/pt-BR/browsers.md)
- [Ferramentas de detecção](docs/pt-BR/detection-tools.md)
- [Automação](docs/pt-BR/automation-tools.md)
- [Tecnologia de fingerprint](docs/pt-BR/fingerprint-technologies.md)
- [Pesquisa](docs/pt-BR/research.md)
